...
function AboutSection() {
    ...
    if ($[0] !== "19b63ea5f335a1ef17676867ff3c5b5bea116c4b9fa20c30b38be49ddd080b75") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "19b63ea5f335a1ef17676867ff3c5b5bea116c4b9fa20c30b38be49ddd080b75";
    }
    let t0;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(_AboutSectionUseEffect, t0);
    let t1;
...
_c = AboutSection;
function _AboutSectionUseEffect() {
    const elements = document.querySelectorAll("[data-animate]");
    const observer = new IntersectionObserver(_temp, {
        threshold: 0.2
    });
    elements.forEach({
        "AboutSection[useEffect() > elements.forEach()]": (el)=>observer.observe(el)
    }["AboutSection[useEffect() > elements.forEach()]"]);
    return ()=>observer.disconnect();
}
function _temp(entries, obs) {
    entries.forEach({
        "AboutSection[useEffect() > <anonymous> > entries.forEach()]": (entry)=>{
            if (entry.isIntersecting) {
                entry.target.classList.add("is-visible");
                obs.unobserve(entry.target);
            }
        }
    }["AboutSection[useEffect() > <anonymous> > entries.forEach()]"]);
}
var _c;
...
function HeroHome() {
    ...
    if ($[0] !== "ea0c605a96d9197b56eed22341401fac4ea899397547d2e81e7232b5aa5af828") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ea0c605a96d9197b56eed22341401fac4ea899397547d2e81e7232b5aa5af828";
    }
    let t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
//# sourceMappingURL=src_0600c5c5._.js.map